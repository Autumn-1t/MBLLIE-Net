...
class OursDataset(BaseDataset):
    ...
    def __init__(self, opt):
        ...
        if opt.phase == 'train':
            #Fill the full path
            self.train_dir_HI = os.path.join(opt.dataroot, 'train/target')#label
            self.train_dir_LI = os.path.join(opt.dataroot, 'train/input')#Input
            ...
            self.test_dir_HI = os.path.join(opt.dataroot, 'test/target')#label
            self.test_dir_LI = os.path.join(opt.dataroot, 'test/input')#Input
            #Get all image paths list
