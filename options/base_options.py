...
class BaseOptions:
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--dataroot', type=str, default='./datasets/LOLdataset', help='Dataset path')

        parser.add_argument('--name', type=str, default='MBPN', help='Name of experiment')
        ...
        parser.add_argument('--dataset_size', type=int, default=485, help='train dataset size')
        ...
        parser.add_argument('--lr', type=float, default=0.0003, help='learning rate for adam')
        parser.add_argument('--epoch_count', type=int, default=1, help='the starting epoch count')
        parser.add_argument('--isTrain',action='store_true', default=False, help='Whether the training')
